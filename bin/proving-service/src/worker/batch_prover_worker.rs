...
use crate::{
    api::batch_prover_api::BatchProverRpcListener, generated::batch_prover::api_server::ApiServer,
...
pub async fn start(worker_addr: String) -> Result<(), String> {
    let rpc = BatchProverRpcListener::new(
    ...
    health_reporter.set_serving::<ApiServer<BatchProverRpcListener>>().await;
