...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + core::marker::Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::ProveTransactionResponse>, tonic::Status>
        {
...
pub mod api_server {
    ...
    #[async_trait]
    pub trait Api: core::marker::Send + core::marker::Sync + 'static {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/api.Api/ProveTransaction" => {
                    ...
                    let fut = async move {
                        let method = ProveTransactionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
