...
///
/// > hash(hash(hash(serial_num, ZERO), script_commitment), input_commitment)
///
...
///   serial_num (as well as script commitment, input commitment, and note assets) is sufficient.
