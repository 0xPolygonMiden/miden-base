...
const KERNEL0_PROCEDURES: [Digest; 28] = [
    ...
    // get_account_item
    digest!(
        12870368003864147532,
        135004044775175452,
        18341205336754684006,
        16511632309455617110
    ),
    // get_account_map_item
    digest!(
        1722959968055615999,
        12509825287842064187,
        15844741291956278184,
    ...
    // set_account_item
    digest!(
        15764319909714146584,
        7841587466640850169,
        12756932643091096464,
        15802692116963007064
    ),
    // set_account_map_item
    digest!(
        11056255565559326609,
        1357562972439875440,
        5479599748803854851,
        17981458485658454761
    ),
    // burn_asset
    digest!(
