...
pub const ERR_CURRENT_ACCOUNT_IS_NOT_NATIVE: u32 = 0x00020054;
...
pub const ERR_PROC_INDEX_OUT_OF_BOUNDS: u32 = 0x0002004b;
pub const ERR_PROC_NOT_PART_OF_ACCOUNT_CODE: u32 = 0x0002004a;
...
pub const KERNEL_ERRORS: [(u32, &str); 70] = [
    ...
    (ERR_CURRENT_ACCOUNT_IS_NOT_NATIVE, "The current account is not native"),
    ...
    (ERR_PROC_NOT_PART_OF_ACCOUNT_CODE, "Account procedure is not part of the account code"),
