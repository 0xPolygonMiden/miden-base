...
fn test_storage_offset() {
    ...
    let procedures_with_offsets = vec![
        AccountProcedureInfo::new(*code.procedures()[0].mast_root(), 2, 5),
        AccountProcedureInfo::new(*code.procedures()[1].mast_root(), 2, 5),
        AccountProcedureInfo::new(*code.procedures()[2].mast_root(), 1, 5),
        AccountProcedureInfo::new(*code.procedures()[3].mast_root(), 1, 5),
    ];
