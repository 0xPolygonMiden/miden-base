...
use miden_lib::transaction::{
    memory::{
        ...
        ACCT_ID_PTR, ACCT_PROCEDURES_SECTION_OFFSET, ACCT_STORAGE_ROOT_PTR, ACCT_VAULT_ROOT_PTR,
        ...
        NULLIFIER_DB_ROOT_PTR, NUM_ACCT_PROCEDURES_PTR, PREV_BLOCK_HASH_PTR, PROOF_HASH_PTR,
