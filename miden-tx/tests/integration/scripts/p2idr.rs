...
fn p2idr_script() {
    ...
    // consume the note.  Case "reclaimable": block height is 4, reclaim block height is 3.
    // Target and sender account can consume the note.  The malicious account should never be
