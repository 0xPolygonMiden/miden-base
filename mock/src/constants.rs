...
pub const ACCOUNT_SEED_FUNGIBLE_FAUCET_INVALID_INITIAL_BALANCE: [u64; 4] = [
    4837964420216095321,
    14719513826019085120,
    8048017050177882048,
    360627022571283172,
];
pub const ACCOUT_ID_FUNGIBLE_FAUCET_INVALID_INITIAL_BALANCE: u64 = 12081207106969327678;

pub const ACCOUNT_SEED_FUNGIBLE_FAUCET_VALID_INITIAL_BALANCE: [u64; 4] = [
    12136709200684823055,
    1824916237097495284,
    8549090351365901331,
    6574931573032265039,
];
pub const ACCOUNT_ID_FUNGIBLE_FAUCET_VALID_INITIAL_BALANCE: u64 = 12053881223939253326;

pub const ACCOUNT_SEED_NON_FUNGIBLE_FAUCET_INVALID_RESERVED_SLOT: [u64; 4] = [
    10052841723745570425,
    12895187162113480993,
    17823370665452510718,
    13480704032776323398,
];
pub const ACCOUNT_ID_NON_FUNGIBLE_FAUCET_INVALID_RESERVED_SLOT: u64 = 16874984845583919667;

pub const ACCOUNT_SEED_NON_FUNGIBLE_FAUCET_VALID_RESERVED_SLOT: [u64; 4] = [
    17365960489267401602,
    2929548604532531452,
    1680093318753782580,
    17881887510011443259,
];
pub const ACCOUNT_ID_NON_FUNGIBLE_FAUCET_VALID_RESERVED_SLOT: u64 = 16423399875750953543;
